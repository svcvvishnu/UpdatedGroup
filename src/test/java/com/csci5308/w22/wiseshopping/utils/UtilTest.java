...
public class UtilTest {
    ...
    public void testInvalidInputParameterParseTime(){
        IllegalArgumentException exception = Assertions.assertThrows(IllegalArgumentException.class, () ->Util.parseTime("11:00:00:00"));
        Assertions.assertEquals("Invalid argument for time.\n Expected format : HH:MM",exception.getMessage());

        IllegalArgumentException exception2 = Assertions.assertThrows(IllegalArgumentException.class, () ->Util.parseTime("11d"));
